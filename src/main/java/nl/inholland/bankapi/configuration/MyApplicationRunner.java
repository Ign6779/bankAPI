...
//        ));
        ...
        transactionRepository.saveAll(List.of(
                ...
                new Transaction(LocalDateTime.of(2023, Month.MARCH, 2, 12, 30, 45), bankAccounts.get(1), bankAccounts.get(1), 200.0, "1cfc38d6-e378-11ed-b5ea-0242ac120002"),
                ...
                new Transaction(LocalDateTime.of(2023, Month.MARCH, 7, 12, 30, 45), bankAccounts.get(1), bankAccounts.get(1), 700.0, "1cfc38d6-e378-11ed-b5ea-0242ac120002"),
                new Transaction(LocalDateTime.of(2023, Month.MARCH, 8, 12, 30, 45), bankAccounts.get(1), bankAccounts.get(1), 800.0, "1cfc38d6-e378-11ed-b5ea-0242ac120002"),
                new Transaction(LocalDateTime.of(2023, Month.MARCH, 9, 12, 30, 45), bankAccounts.get(1), bankAccounts.get(2), 900.0, "1cfc38d6-e378-11ed-b5ea-0242ac120002")
        ));
